    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50">
      ...
      <div className="relative group">
        ...
        <div className="absolute right-0 mt-3 w-64 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-slate-200 py-3 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 scale-95 group-hover:scale-100">
          <Link to="/admin/profile" className="flex items-center gap-4 px-6 py-4 hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 rounded-2xl mx-2 font-semibold text-slate-900 transition-all">
          ...
          <button className="w-full text-left px-6 py-4 hover:bg-gradient-to-r hover:from-red-50 hover:to-rose-50 rounded-2xl mx-2 font-semibold text-slate-900 transition-all">
            <div className="flex items-center gap-4">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
              ...
              <div className="space-y-4">
                <Link to="/admin/create-event" className="group block p-6 rounded-2xl bg-gradient-to-r from-purple-50 to-indigo-50 border-2 border-purple-100">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">➕</span>
                    <span className="font-bold text-purple-700 group-hover:text-purple-800">Create Event</span>
                  </div>
                </Link>
                <Link to="/admin/registrations" className="group block p-6 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 border-2 border-emerald-100">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">📋</span>
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl group border border-slate-100">
                ...
                <Link to="/admin/event-details" className="w-full block bg-gradient-to-r from-purple-500 to-purple-600 text-white py-3 px-6 rounded-2xl text-center font-bold hover:brightness-105">
                  View Details
                </Link>
              </div>
            </div>
