...
function CollegeAdminDashboard() {
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-purple-50">
     ...
     <Navbar />
      ...
      <Link
        ...
        className="group block p-6 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-100"
      >
        <div className="flex items-center gap-3 mb-2">
          <span className="text-2xl">📊</span>
  ...
  <Link to="/admin/dashboard/events" className="text-purple-600 hover:underline text-lg font-semibold">
      View All →
    </Link>
