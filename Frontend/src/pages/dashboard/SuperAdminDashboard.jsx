      ...
      <header className="bg-white/90 backdrop-blur-md shadow-sm border-b border-slate-200/50 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl border-4 border-white">
          ...
          <div className="relative group">
            <button className="flex items-center gap-3 p-3 rounded-2xl hover:bg-slate-100 transition-all duration-200">
              <div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg ring-2 ring-white/50">
            ...
            <div className="absolute right-0 mt-3 w-72 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-slate-200 py-3 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 scale-95 group-hover:scale-100">
              ...
              <div className="px-6 py-4">
                <Link 
                  ...
                  className="w-full flex items-center gap-3 px-6 py-4 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-2xl font-semibold text-slate-900 transition-all shadow-sm"
                >
              ...
              <div className="px-6 py-3 border-t border-slate-100">
                <button className="w-full text-left px-4 py-3 hover:bg-gradient-to-r hover:from-red-50 hover:to-rose-50 rounded-2xl font-semibold text-slate-800 transition-all text-sm">
          ...
          {systemStats.map((stat, index) => (
            <div key={index} className="bg-white rounded-3xl p-8 shadow-2xl hover:shadow-3xl group border border-indigo-100/50">
              <div className="flex items-center gap-4 mb-6">
                <div className={`w-20 h-20 bg-gradient-to-r from-${stat.color}-500 to-${stat.color}-600 rounded-3xl flex items-center justify-center shadow-2xl group-hover:scale-110 transition-all`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 bg-white rounded-3xl p-10 shadow-2xl border border-slate-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-100">
                <div className="text-4xl mb-4">🏫</div>
                <div className="text-3xl font-black text-indigo-700">47</div>
                <p className="text-slate-600 font-semibold">Active Colleges</p>
              </div>
              <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-emerald-100">
                <div className="text-4xl mb-4">📈</div>
          ...
          <div className="space-y-6">
            <Link to="/super-admin/colleges" className="block bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-8 rounded-3xl shadow-2xl hover:shadow-3xl hover:-translate-y-2 transition-all text-center font-bold text-xl">
              Manage Colleges
            </Link>
            <Link to="/super-admin/reports" className="block bg-gradient-to-r from-emerald-500 to-teal-600 text-white p-8 rounded-3xl shadow-2xl hover:shadow-3xl hover:-translate-y-2 transition-all text-center font-bold text-xl">
              Analytics Reports
            </Link>
          </div>
        </div>
