...
import { 
  FaUsers, FaCalendarAlt, FaCheckCircle, FaExclamationTriangle, 
  FaSearch, FaUserPlus, FaChartBar, FaEye, FaClock, FaBell, 
  FaEdit 
} from "react-icons/fa";

function SuperAdminDashboard() {
  const [stats, setStats] = useState({
    totalEvents: 124, totalColleges: 23, totalRegistrations: 2341, pendingEvents: 6
  });
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-indigo-50/30 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-xl text-slate-600 mt-1">Platform-wide management & analytics</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Link to="/super-admin/events" className="group">
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all border border-slate-100">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-600 uppercase tracking-wide">Total Events</p>
                    <p className="text-3xl font-black text-slate-900">{stats.totalEvents}</p>
                  </div>
                </div>
                <p className="text-slate-500 text-sm flex items-center gap-1">
                  <FaClock className="text-amber-500" /> {stats.pendingEvents} pending
                </p>
              </div>
            </Link>
            ...
            <Link to="/super-admin/colleges" className="group">
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all border border-slate-100">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-600 uppercase tracking-wide">Colleges</p>
                    <p className="text-3xl font-black text-slate-900">{stats.totalColleges}</p>
                  </div>
                </div>
            ...
            <Link to="/super-admin/reports" className="group">
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all border border-slate-100">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-600 uppercase tracking-wide">Registrations</p>
                    <p className="text-3xl font-black text-slate-900">{stats.totalRegistrations.toLocaleString()}</p>
                  </div>
                </div>
                <p className="text-slate-500 text-sm">Total student registrations</p>
              </div>
            </Link>
            ...
            <Link to="/super-admin/pending-colleges" className="group">
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all border border-slate-100">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-600 uppercase tracking-wide">Pending Colleges</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Link to="/super-admin/pending-events" className="group bg-gradient-to-br from-amber-50 to-orange-50 p-8 rounded-3xl shadow-xl hover:shadow-2xl border border-amber-200">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-black text-slate-900">Pending Events</h3>
                  <p className="text-slate-600">{stats.pendingEvents} events awaiting approval</p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <Link to="/super-admin/colleges" className="block w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white p-6 rounded-3xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all text-center">
              ...
              <Link to="/super-admin/reports" className="block w-full bg-gradient-to-r from-purple-500 to-indigo-600 text-white p-6 rounded-3xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all text-center">
