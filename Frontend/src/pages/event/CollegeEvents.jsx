          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-6">
            {filteredEvents.map((event) => (
              <Link
                ...
                className="group"
              >
                <div className="bg-white rounded-2xl shadow-md hover:shadow-xl border border-gray-100 hover:border-purple-200 transition-all duration-300 overflow-hidden h-full flex flex-col">
                  {/* ✅ Event Image - shows uploaded image OR fallback gradient */}
