// src/pages/event/CollegeEventDetails.jsx
...
function CollegeEventDetails() {
  ...
  const getCategoryColor = (category) => {
    const colors = {
      sports: "bg-green-100 text-green-800",   hackathon: "bg-blue-100 text-blue-800",
      cultural: "bg-purple-100 text-purple-800", workshop: "bg-orange-100 text-orange-800",
      seminar: "bg-red-100 text-red-800",       technical: "bg-indigo-100 text-indigo-800",
      social: "bg-pink-100 text-pink-800",      other: "bg-gray-100 text-gray-800",
    };
          ...
          <div className="flex items-center gap-3 bg-indigo-50 border border-indigo-200 rounded-xl px-5 py-3 mb-6">
            ...
            <div>
              ...
              <p className="text-indigo-600 text-xs mt-0.5">
                You can view and reply to all student comments. Your replies will show an <span className="font-bold">Admin</span> badge.
              </p>
            </div>
          </div>
