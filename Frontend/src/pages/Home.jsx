...
const Hero = () => {
  return (
    <>
      ...
      <section className="min-h-screen bg-linear-to-br from-indigo-500 to-purple-700 flex items-center relative overflow-hidden py-20 px-5">
        {/* Decorative Circles */}
        <div className="absolute w-100 h-100 rounded-full bg-white/10 -top-24 -right-24 blur-[60px] pointer-events-none" />
        <div className="absolute w-75 h-75 rounded-full bg-white/10 -bottom-12 -left-12 blur-[60px] pointer-events-none" />

        <div className="max-w-300 mx-auto w-full relative z-10">
          <div className="flex items-center gap-14 flex-wrap">

            {/* Left Section */}
            <div className="flex-1 min-w-75 text-white">
              ...
              <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6">
                Your Gateway to <br />
                <span className="bg-linear-to-r from-yellow-200 to-blue-700 bg-clip-text text-transparent">
                  Every College Event
                </span>
              </h1>
            ...
            {/* Right Section */}
            <div className="flex-1 min-w-75 flex justify-center items-center">
              <div className="relative max-w-125 w-full">
                {/* Image */}
                <div
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-linear-to-br from-indigo-500 to-purple-700 flex items-center justify-center text-white text-lg">
                    <FaTrophy />
                  </div>
                  <div className="flex flex-col">
                ...
                >
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center text-white text-lg bg-linear-to-br from-pink-400 to-rose-500">
                    <FaCalendarCheck />
                  </div>
                  <div className="flex flex-col">
