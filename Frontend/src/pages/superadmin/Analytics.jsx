...
import {
  FaChartLine, // ✅ valid
  FaUsers, // ✅ valid
  FaCalendarDays, // ✅ valid
  FaCircleCheck, // ✅ valid
  // ❌ REMOVED: FaChartBar, FaTicket, FaIndianRupee, FaDownload, FaCalendarAlt, FaTicketAlt
  // — none of these exist in react-icons v5 fa6
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-12">
          ...
          <div className="flex gap-3">
            ...
            {/* ✅ FIX: Replaced <FaDownload /> (invalid) with 📥 emoji */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          {/* Events Chart */}
          {/* ✅ FIX: Replaced <FaChartBar /> (invalid) with 📊 emoji */}
          <div className="bg-white p-10 rounded-3xl shadow-2xl border border-slate-100">
            <h3 className="text-2xl font-bold text-slate-900 mb-8 flex items-center gap-3">
              ...
              <div className="grid grid-cols-5 gap-2 h-32 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-3xl border border-emerald-200 items-end">
                {eventData.map((value, index) => (
                  <div
                    ...
                    style={{
                      height: `${(value / Math.max(...eventData)) * 100}%`,
                    }}
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Quick Actions */}
          {/* ✅ FIX: Replaced FaCalendarAlt & FaTicketAlt (invalid) with FaCalendarDays & emojis */}
