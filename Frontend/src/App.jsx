...
import AllRegistrations from "./pages/superadmin/AllRegistratons";
// Feedback
import EventFeedback from "./pages/student/EventFeedback";
import FeedbackAnalytics from "./pages/admin/FeedbackAnalytics";
import StudentRegistrations from "./pages/superadmin/StudentRegistrations";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/super-admin/students" element={
          <ProtectedRoute role="super_admin"><AllStudents/></ProtectedRoute>
        }/>
        <Route path="/super-admin/registrations" element={
          <ProtectedRoute role="super_admin"><AllRegistrations/></ProtectedRoute>
        }/>

        <Route path="/super-admin/students/:id" element={
          <ProtectedRoute role="super_admin"><StudentRegistrations/></ProtectedRoute>
        }/>
